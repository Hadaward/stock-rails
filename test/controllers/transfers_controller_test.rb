...
class TransfersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transfer" do
    assert_difference('Transfer.count') do
      post transfers_url, params: { transfer: { in: @transfer.in, out: @transfer.out, quantity: @transfer.quantity } }
    end
  ...
  test "should update transfer" do
    patch transfer_url(@transfer), params: { transfer: { in: @transfer.in, out: @transfer.out, quantity: @transfer.quantity } }
